...
<div class="dashboard-main-body">
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="card-title mb-0">Form Edit Pegawai</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('spv.pegawai.update', $pegawai) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('unit_kerja') is-invalid @enderror" id="unit_kerja" name="unit_kerja" value="{{ old('unit_kerja', $pegawai->unit_kerja) }}" required>
                        @error('unit_kerja')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('telepon') is-invalid @enderror" id="telepon" name="telepon" value="{{ old('telepon', $pegawai->telepon) }}">
                        @error('telepon')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
