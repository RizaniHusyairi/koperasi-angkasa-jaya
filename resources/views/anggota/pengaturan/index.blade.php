    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0">Perbarui Profil</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('anggota.pengaturan.profile') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nomor_wa') is-invalid @enderror" id="nomor_wa" name="nomor_wa" value="{{ old('nomor_wa', $anggota->nomor_wa) }}" placeholder="08xxxxxxxxxx">
                            @error('nomor_wa')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('anggota.pengaturan.password') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <button type="submit" class="btn btn-warning-600">
                            <iconify-icon icon="mdi:lock-reset" class="icon me-1"></iconify-icon>
                            Ubah Password
                        </button>
                    </form>
                </div>
